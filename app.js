...
const randomMessageGenerator = () => {
  return `When I go to the arcade with my ${pluralNounList[randomNumberGenerator(20)]} 
there are lots of games to play. I spend lots of time there with my friends. 
In the game X-Men you can be different ${pluralNounList[randomNumberGenerator(20)]}. 
...
done you can cash in your tickets to get a big ${nounList[randomNumberGenerator(20)]}. 
You can save your ${pluralNounList[randomNumberGenerator(20)]} for another time. 
